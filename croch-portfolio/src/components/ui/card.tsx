...
const Card = React.forwardRef<HTMLDivElement, React.HTMLAttributes<HTMLDivElement>>(({ className, ...props }, ref) => (
  <div ref={ref} className={cn("rounded-3xl border border-white/10 bg-[rgba(14,19,36,0.92)] shadow-[0_0_0_1px_rgba(255,255,255,0.02)] backdrop-blur-xl", className)} {...props} />
));
